      ...
      <div className="bg-white h-[100vh]">
        <div className="w-full bg-white flex flex-col  justify-center">
          <img
            ...
            src="https://www.nadaalnahdi.com/wp-content/uploads/2019/01/nada-al-nahdi-things-to-do-in-jeddah-jeddah-sign-jeddah-sign-corniche-saudi-arabia-3-845x550.jpeg"
            alt=""
          />
