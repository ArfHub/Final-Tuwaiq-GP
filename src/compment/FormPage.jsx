...
const FormPage = () => {
  ...
  return (
    <div className="bg-white w-full overflow-x-hidden ">
      <Navbar />
      {/**all div */}
      <div className="flex bg-gradient-to-r from-orange-50 to-orange-100   flex-row gap-5  shadow-2xl  px-10 md:p-0 rounded-lg ml-20 md:ml-48 mt-10 w-[65%] h-[800px] md:h-[470px] mb-10 ">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-row relative items-center w-[100px]">
              <select
                ...
                className="w-full md:w-[150px] text-sm p-1 rounded-lg border-2 border-gray-100 focus:outline-gray-200 bg-white text-black"
              >
          ...
          <div className="flex flex-col  w-full">
            ...
            <div className="flex flex-row relative p-1 items-center w-[150px]">
              <input
                ...
                className="w-[150px] border-2 text-black text-sm border-gray-100 focus:outline-gray-200 p-1 rounded-lg items-center bg-white"
          ...
          <div className="flex flex-col w-full  gap-1">
            ...
            <div className="flex flex-row relative items-center w-[150px]">
              <input
                ...
                className="p-1 w-[150px] text-sm text-black bg-white border-2 border-gray-100 focus:outline-gray-200 rounded-lg items-center"
                placeholder="Write here"
              />
              <FaPeopleGroup className="absolute right-1 text-[1.2rem] text-gray-400" />
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-row relative items-center w-[150px]">
              <textarea
                ...
                className=" text-black w-[150px] text-sm bg-white border-2 border-gray-100 focus:outline-gray-200 p-1 rounded-lg items-center h-[35px]"
                placeholder="Write here"
              />
            </div>
          </div>
