      ...
      <header className="bg-white shadow">
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          ...
          >
            <Link
              to="/Destinations"
              className="text-gray-700 hover:text-orange-500 transform transition-transform duration-300 hover:scale-105"
            >
              Destinations
            </Link>
          </nav>
          <div
            className={`lg:flex lg:space-x-2 ${isOpen ? 'block' : 'hidden'}`}
          >
            {isLoggedIn ? (
