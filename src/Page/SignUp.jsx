                ...
                <form onSubmit={handleSubmit}>
                  <div className="mx-auto max-w-xs">
                    ...
                    <input
                      ...
                      id="password"
                    />
                    <button className="mt-5 tracking-wide font-semibold bg-orange-50 text-white-500 w-full py-4 rounded-lg bg-orange-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                      <svg
