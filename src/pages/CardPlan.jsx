    ...
    <div className="flex flex-col items-center ">
      ...
      <div className="CARDCONTAINER flex justify-center">
        <div className="flex flex-wrap justify-center bg-gray-100 rounded-lg relative w-fit h-auto ">
          ...
          <div className="w-full  group sm:w-fit flex justify-center p-2 z-10">
            {/* ===============SAVE AS PDF BUTTON=============== */}
            <div className="dropdown w-full">
              <div
                tabIndex={0}
          ...
          <div className="w-full group sm:w-fit flex justify-center p-2">
            {/* ===============DAYS BUTTON=============== */}
            <details className="dropdown w-full bg-none">
              ...
              <ul className="menu dropdown-content  group-hover:opacity-100 opacity-0 bg-white rounded-box z-10 w-52 p-2 text-black shadow-md">
